...
to {
  ...
  opacity: 1;
    ...
    forwards;
`,G=({toast:t})=>{let{icon:e,type:r,iconTheme:a}=t;return void 0!==e?"string"==typeof e?s.createElement(Y,null,e):e:"blank"===r?null:s.createElement(R,null,s.createElement(Z,{...a}),"loading"!==r&&s.createElement(B,null,"error"===r?s.createElement(X,{...a}):s.createElement(q,{...a})))},J=t=>`
